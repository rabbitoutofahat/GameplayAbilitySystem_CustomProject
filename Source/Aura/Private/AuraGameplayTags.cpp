...
void FAuraGameplayTags::InitialiseNativeGameplayTags()
{
	...
	*/
	...
	GameplayTags.GameplayCue_ReviveExplosion = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("GameplayCue.ReviveExplosion"), FString("Gameplay Cue for Explosion Effects On Demonic Soul Revive when using certain upgrade"));
	...
	GameplayTags.Buff_PortentOfDestruction = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Buff.PortentOfDestruction"), FString("Given to the Vessel, making the next cast of Summon Dregling cost no Souls"));
}
